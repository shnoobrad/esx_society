Locales['en'] = {
  ...
  ['no_access'] = 'you do not have access to this', -- shnoob
  ['no_permission'] = 'you do not have permission to do this', -- shnoob
  ['amount_too_high'] = 'amount exceeds the maximum limit', -- shnoob
  ['invalid_label'] = 'invalid label provided', -- shnoob
  ['invalid_grade'] = 'invalid grade selected', -- shnoob
}
